...
def rcmd(movie):
    ...
    if m not in data['movie_title'].unique():
        ...
        for i in range(len(m_lst)):
            a = m_lst[i][0]
            m_info.append(data['movie_title'][a])
        return m_info
...
def recommend():
    ...
    # every string converted into list
    ...
    #sauce = urllib.request.urlopen('https://www.imdb.com/title/{}/reviewa?ref_=tt_ov_rt'.format(imdb_id)).read()
    ...
    #print(movie_reviews,rec_posters)

    # Passed all the data to html files
